...
bool recursive(int *p, int a, int b)
{
    ...
    if (b == a + 1)
        ...
        return (p[a] == p[b]) && recursive(p, a+1, b-1);
}
...
int main(int argc, const char * argv[]) {
    ...
    cout << "\t" << "sym (r) = " << recursive(ints_even2, 0, 6-1) << endl;
    cout << "\t" << "sym (i) = " << iterative(ints_even2, 6) << endl;
    
    cout << "ints_odd1  = "; print(ints_odd1, 7);
    cout << "\t" << "siz = " << 7 << endl;
    cout << "\t" << "tot = " << findtotal(ints_odd1, 0, 7-1) << endl;
    cout << "\t" << "avg = " << findtotal(ints_odd1, 0, 7-1) / ((7-1) - 0) << endl;
    cout << "\t" << "sym (r) = " << recursive(ints_odd1, 0, 7-1) << endl;
    cout << "\t" << "sym (i) = " << iterative(ints_odd1, 7) << endl;
    
    cout << "ints_odd2  = "; print(ints_odd2, 7);
    cout << "\t" << "siz = " << 7 << endl;
    cout << "\t" << "tot = " << findtotal(ints_odd2, 0, 7-1) << endl;
    cout << "\t" << "avg = " << findtotal(ints_odd2, 0, 7-1) / ((7-1) - 0) << endl;
    cout << "\t" << "sym (r) = " << recursive(ints_odd2, 0, 7-1) << endl;
    cout << "\t" << "sym (i) = " << iterative(ints_odd2, 7) << endl;
    ...
    cout << "\t" << "sym (r) = " << recursive(ints_user1, 0, size1-1) << endl;
    cout << "\t" << "sym (i) = " << iterative(ints_user1, size1) << endl;
    ...
    cout << "\t" << "sym (r) = " << recursive(ints_user2, 0, size2-1) << endl;
    cout << "\t" << "sym (i) = " << iterative(ints_user2, size2) << endl;
    
    
    
    //2D ARRAY PRINTING
    cout << "two_d_ints3 = "; print(two_d_ints3, 6, 6);
    cout << "\t" << "siz = " << 6*6 << endl;
    
    cout << "two_d_ints5 = "; print(two_d_ints5, 1, 4);
    cout << "\t" << "siz = " << 1*4 << endl;
    
    cout << "two_d_ints4 = "; print2(two_d_ints4, 7, 4);
    cout << "\t" << "siz = " << 7*4 << endl;
